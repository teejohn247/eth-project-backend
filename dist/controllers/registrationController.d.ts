...
export declare const addBulkSlots: (req: AuthenticatedRequest, res: Response) => Promise<void>;
export declare const processBulkPayment: (req: AuthenticatedRequest, res: Response) => Promise<void>;
export declare const addParticipantToRegistration: (req: AuthenticatedRequest, res: Response) => Promise<void>;
