...
const users = [
  { firstName: 'Divine', lastName: 'Agbonlahor Osawoname', email: 'evanchenthesurgeon@gmail.com', password: 'MightyHawk364%', file: '1-divine-evanchenthesurgeon' },
  { firstName: 'Divine', lastName: 'Agbonlahor Osawoname', email: 'classicosonic7@gmail.com', password: 'OceanSwift249&', file: '2-divine-classicosonic7' },
  { firstName: 'Osayande', lastName: 'Uwa Matthew', email: 'benardgregory935@gmail.com', password: 'MountainBear517$', file: '3-osayande-benardgregory935' },
  { firstName: 'Minloveth', lastName: 'Owenaze', email: 'lovethowenaze85@gmail.com', password: 'CrystalNoble365$', file: '4-minloveth-lovethowenaze85' },
  { firstName: 'Cha', lastName: 'Nath', email: 'omofowaaroma@gmail.com', password: 'ApexCrystal515*', file: '5-cha-omofowaaroma' },
  { firstName: 'OSEMWENGIE', lastName: 'EHIZPRAIZE', email: 'ehizpraize58@gmail.com', password: 'TigerMighty823&', file: '6-osemwengie-ehizpraize58' },
  { firstName: 'Osas', lastName: 'Paul', email: 'osasokunrobo1@gmail.com', password: 'TigerPrime540%', file: '7-osas-osasokunrobo1' }
];

// Text template
const textTemplate = (firstName, lastName, email, password) => `═══════════════════════════════════════════════════════════
EDO TALENT HUNT - ACCOUNT ACTIVATION NOTIFICATION
═══════════════════════════════════════════════════════════

Dear ${firstName} ${lastName},

Great news! Your account has been successfully activated and is now 
ready to use.
...
LOGIN URL: https://edotalenthunt.com/login

If you have any questions or need assistance, please don't hesitate 
to contact our support team.

Best regards,
Edo Talent Hunt Team
...
console.log('Generating all email files...\n');

users.forEach(user => {
  // Generate text email
  const txt = textTemplate(user.firstName, user.lastName, user.email, user.password);
  fs.writeFileSync(`emails/${user.file}.txt`, txt);
  console.log(`✅ Created emails/${user.file}.txt`);
...
console.log('\n═══════════════════════════════════════════════════════════');
console.log('✅ All email files generated successfully!');
console.log('═══════════════════════════════════════════════════════════\n');

console.log('Passwords Summary:');
