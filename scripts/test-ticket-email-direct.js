...
async function sendTestTicketEmail() {
  try {
    console.log('🎟️ Sending Test Ticket Email Directly\n');
    ...
    console.log('   Using EmailService from dist/services/emailService.js');
    console.log('');
    ...
    console.log('🎨 The email uses the new dark theme design');
